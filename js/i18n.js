...
const DICT = {
  ...
  "bk.email.ph": ["name@example.com", "nom@exemple.com"],
  ...
  "ap.resched.title": ["Pick a new time", "Choisissez une nouvelle heure"],
  "ap.resched.now": ["Currently {d}", "Actuellement le {d}"],
  "ap.resched.cta": ["Move it here", "Déplacer ici"],
  "ap.resched.done": ["Moved to {d}", "Déplacé au {d}"],
  "ap.resched.current": ["Your current time", "Votre heure actuelle"],
  "ap.resched.late": ["This is inside the {n}-hour window. Please call us to move it.",
                      "Nous sommes à moins de {n} heures. Merci de nous appeler pour le déplacer."],
